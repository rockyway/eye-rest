...
- `C:\Users\tamtr\AppData\Roaming\EyeRest\logs\eyerest.log` - Application logs
- `D:\sources\demo\eye-rest\App.xaml.cs:207-337` - Backup trigger system  
- `D:\sources\demo\eye-rest\Services\TimerService.cs` - Health monitoring
- `D:\sources\demo\eye-rest\Services\ApplicationOrchestrator.cs` - Service coordination

## ⚡ Quick Recovery Commands

### Build & Run
```bash
cd "D:\sources\demo\eye-rest"
dotnet build
dotnet run
```
