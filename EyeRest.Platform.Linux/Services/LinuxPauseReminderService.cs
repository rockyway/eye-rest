...
{
    /// <summary>
    /// Linux implementation of <see cref="IPauseReminderService"/>.
    /// Uses notify-send (org.freedesktop.Notifications) for desktop notifications
    /// and System.Threading.Timer for scheduling reminders. The timer/state logic
    /// is the same as the macOS implementation.
    /// </summary>
    public class LinuxPauseReminderService : IPauseReminderService
    {
        private readonly ILogger<LinuxPauseReminderService> _logger;
        ...
        public LinuxPauseReminderService(ILogger<LinuxPauseReminderService> logger)
        {
        ...
        {
            _logger.LogInformation("Linux pause reminder service initialized");
        ...
        {
            // Auto-confirm, same as macOS — confirmation dialogs are handled by the
            // Avalonia layer where needed.
        ...
        {
            LinuxNotifications.Send(_logger,
        ...
        public void Dispose()
        {
            ...
            StopTimers();
            _logger.LogInformation("LinuxPauseReminderService disposed");
