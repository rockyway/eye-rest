...
namespace EyeRest.Views
{
    public partial class BreakWarningPopup : UserControl
    {
        ...
        public void StartCountdown(TimeSpan timeUntilBreak)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"🟠 BreakWarningPopup: Starting display-only countdown for {timeUntilBreak.TotalSeconds} seconds");
        ...
        {
            System.Diagnostics.Debug.WriteLine($"🟠 BreakWarningPopup: UpdateCountdown called with {remaining.TotalSeconds} seconds remaining");
            ...
            if (remaining <= TimeSpan.Zero)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"🟠 BreakWarningPopup: Countdown complete - firing Completed event");
        ...
        public void StopCountdown()
        {
            ...
            System.Diagnostics.Debug.WriteLine($"🟠 BreakWarningPopup: StopCountdown called");
        }
